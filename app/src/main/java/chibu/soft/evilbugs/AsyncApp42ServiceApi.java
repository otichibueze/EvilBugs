...
public class AsyncApp42ServiceApi {
	...
	private AsyncApp42ServiceApi() {
		ServiceAPI sp = new ServiceAPI("634d3439ea36ddd74edf549b96c10b2f86f5bc661390f98e1156d7fc9ba41da6",
				"2bdb8d5787e7f01763e1021ef2b54ca312871c2cbc5f901ff1b68ed44b3e5aaf");
	...
	/*
	 * This function Edits Users Score for the Given GameName.
	 */
	public void editScoreForUser(final String scoreID,
			 final BigDecimal gameScore, final App42ScoreBoardServiceListener callBack) {
		final Handler callerThreadHandler = new Handler();
		new Thread() {
			@Override
			public void run() {
				try {
					final Game response = scoreBoardService.editScoreValueById(scoreID,gameScore);
					callerThreadHandler.post(new Runnable() {
						@Override
						public void run() {
							callBack.onSuccess(response);
	...
	public static interface App42ScoreBoardServiceListener 
	{
		...
		//void onEditScoreSuccess(Game response); //i just added
		
		//void onEditScoreFailed(App42Exception ex); //i just added
